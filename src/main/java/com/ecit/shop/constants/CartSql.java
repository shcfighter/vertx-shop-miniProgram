...
public interface CartSql {
     ...
     * 查询购物车列表
     */
    String SELECT_CART_SQL = "select cart_id, user_id, commodity_id, commodity_name, num, price::numeric, image_url, specifition_name, create_time, versions from t_cart where user_id = ? and is_deleted = 0 order by create_time desc";
